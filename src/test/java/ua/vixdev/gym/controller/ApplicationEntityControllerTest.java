...
public class ApplicationEntityControllerTest {
  ...
  public void testGetAllApplications_return200Ok() throws Exception {
    ...
    when(applicationService.findAll()).thenReturn(expectedApplications);
  ...
  public void testGetApplicationById() throws Exception {
    when(applicationService.findById(anyInt())).thenReturn(testApplicationDto);
  ...
  public void testDeleteApplication() throws Exception {
    when(applicationService.deleteById(anyInt())).thenReturn(testApplicationDto);
